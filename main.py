...
print(f"✅ 配置加载成功。监控群组: {len(CS_GROUP_IDS)} | 报警接收人: {ALERT_GROUP_IDS} | 监听模式: {'🟢 开启' if _sys_opt else '⚪️ 关闭'}")
...
def _post_request(url, payload):
    try:
        # print(f"正在发送给: {payload['chat_id']}") # 调试用
